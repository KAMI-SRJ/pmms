      ...
      <div class="row">
           <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                  <div class="x_title">
                    <h2>角色管理
                     <a href="${path }/role/add.do?type=99448485485475438573945732020" class="style"><small><i class="fa fa-plus"></i>添加</small></a>
                    </h2>
          ...
          <form class="am-form" action="${path}/role/all.do">
              <div class="x_content">
                ...
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                     <a class="btn btn-success" href="${path }/role/edit.do?id=${p.id}" >修改</a>
                     <a class="btn btn-success" href="${path }/role/delete.do?id=${p.id}">删除</a>
                     </div>
                  </div>
                </td>
              </tr></c:forEach>
