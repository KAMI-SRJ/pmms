...
<!-- page content -->
    <ol class="breadcrumb">
        ...
        <li><a href="${path}/front/article/articleAllByPage.do">新闻列表</a></li>
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div style="margin:20px 185px;">
                ...
                <span class="pull-right">发布日期：<fmt:formatDate value="${article.createDate}" pattern="yyyy-MM-dd"/></span>
                <span class="pull-right">浏览量：${article.viewCount}</span>
            </div>
            <img src="${path}${article.coverImageUrl}">
            <p class="pt">${article.content}</p>
            <div class="page">
                <ul>
                    <li>
                        <span>上一篇:</span>
                        <a href="${path}/front/article/articleDetails.do?id=${pre.id}">${pre.title}</a>
                    </li>
                    <li>
                        <span>下一篇:</span>
                        <a href="${path}/front/article/articleDetails.do?id=${next.id}">${next.title}</a>
                    </li>
                </ul>
            </div>
        </div>
